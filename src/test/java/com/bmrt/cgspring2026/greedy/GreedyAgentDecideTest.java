...
class GreedyAgentDecideTest {
    ...
    @Test
    void dropWhenStandingOnShackAdjacent() {
        GameState s = stateWithTroll(0, 1, 3);
        int a = GreedyAgent.decideForTroll(s, 0, -1);
        assertThat(Action.type(a)).isEqualTo(ActionType.DROP);
        assertThat(Action.trollIdx(a)).isEqualTo(0);
    }

    @Test
    void moveTowardsClosestShackAdjacentWhenCarryingWood() {
        ...
        int a = GreedyAgent.decideForTroll(s, 0, -1);
        assertThat(Action.type(a)).isEqualTo(ActionType.MOVE);
        assertThat(Action.trollIdx(a)).isEqualTo(0);
    ...
    @Test
    void waitWhenNoTreeAvailable() {
        GameState s = stateWithTroll(2, 2, 0);
        int a = GreedyAgent.decideForTroll(s, 0, -1);
        assertThat(Action.type(a)).isEqualTo(ActionType.WAIT);
        assertThat(Action.trollIdx(a)).isEqualTo(0);
    }

    @Test
    void chopWhenStandingOnTargetTree() {
        GameState s = stateWithTroll(3, 2, 0);
        s.treeCount = 1;
        s.treeX[0] = 3;
        s.treeY[0] = 2;
        int a = GreedyAgent.decideForTroll(s, 0, 0);
        assertThat(Action.type(a)).isEqualTo(ActionType.CHOP);
        assertThat(Action.trollIdx(a)).isEqualTo(0);
    }

    @Test
    void moveTowardsTargetTreeWhenNotOnIt() {
    ...
    @Test
    void carryingWoodPriorityOverTreeAssignment() {
    ...
    @Test
    void decideEmptyMapReturnsWaitOnly() {
        GameState s = stateWithTroll(0, 0, 0);
        s.turn = 5;
        int[] buf = new int[GameState.MAX_TROLLS + 1];
        int n = GreedyAgent.decide(s, buf);
        assertThat(n).isEqualTo(1);
        assertThat(Action.type(buf[0])).isEqualTo(ActionType.WAIT);
    }

    @Test
    void decideAssignsClosestFreeTreePerTroll() {
        GameState s = new GameState();
        s.turn = 5;
        s.trollCount = 2;
        s.trollPlayer[0] = 0;
    ...
    void decideDoesNotReassignSameTreeTwice() {
        ...
        assertThat(Action.type(buf[1])).isEqualTo(ActionType.WAIT);
    }

    @Test
    void decideIgnoresEnemyTrolls() {
        GameState s = new GameState();
        s.turn = 5;
        s.trollCount = 2;
        s.trollPlayer[0] = 1;
    ...
    @Test
    void decideEmitsTrainAtTurn0WhenAffordable() {
        GameState s = new GameState();
        s.turn = 0;
        s.trollCount = 1;
        s.trollPlayer[0] = 0;
        ...
        int n = GreedyAgent.decide(s, buf);
        assertThat(n).isEqualTo(2);
        assertThat(Action.type(buf[0])).isEqualTo(ActionType.TRAIN);
        assertThat(Action.type(buf[1])).isEqualTo(ActionType.WAIT);
    }

    @Test
    void decideTrollOnShackMePicksClosestTreeWithoutCrashing() {
        GameState s = new GameState();
        s.turn = 0;
        s.trollCount = 1;
        s.trollPlayer[0] = 0;
        ...
        int last = buf[n - 1];
        assertThat(Action.type(last)).isEqualTo(ActionType.MOVE);
        assertThat(Action.arg1(last)).isEqualTo(3);
        assertThat(Action.arg2(last)).isEqualTo(2);
    }

    @Test
    void decideSkipsTrainAfterTurn0() {
        GameState s = new GameState();
        s.turn = 1;
        s.trollCount = 1;
        s.trollPlayer[0] = 0;
        ...
        int n = GreedyAgent.decide(s, buf);
        assertThat(n).isEqualTo(1);
        assertThat(Action.type(buf[0])).isNotEqualTo(ActionType.TRAIN);
    }

    @Test
    void decideForOpponentReturnsMoveTowardsClosestFreeTreeForOppTroll() {
        GameState s = new GameState();
        s.trollCount = 1;
    ...
    @Test
    void decideForOpponentRespectsTreeTakenBuf() {
        GameState s = new GameState();
        s.trollCount = 1;
        s.trollPlayer[0] = 1;
        s.trollX[0] = 5;
